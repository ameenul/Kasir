...
class TransactionController extends Controller
{
    ...
    {
        //check stock product
        $stock=Product::whereId($request->product_id)->first()->stock ;
    ...
    public function print(Request $request)
    {
        ...
        // $pdf = PDF::loadView('print.nota', compact('transaction'));

        // //PDF for preview / download
        // $pdf->download('nota : '.$request->invoice.'.pdf');
    ...
    public function pdf(Request $request)
    {
        ...
        $customPaper = [0, 0, 223.00, 287];
        // $pdf = PDF::loadView('myPDF', $data)
                    
        
        $pdf = PDF::loadView('print.nota', compact('transaction'))->setPaper($customPaper, 'potrait');

        //PDF for preview / download
        return $pdf->download('nota : '.$request->invoice.'.pdf');

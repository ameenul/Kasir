                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="(vproduct, index) in products" :key="index">
                                            <td>{{ vproduct.title }}</td>
                                            <td>{{ vproduct.stock }}</td>
                                            <td class="text-center">
                                                <input type="radio" v-model="product" name="product" :value="vproduct">
                                ...
                                <div v-if="product.sell_price" class="mb-3">
                                    <label class="form-label fw-bold">Product Price : Rp. {{ formatPrice(product.sell_price)
                                    }}</label>

                                </div>

                                <div v-if="product.sell_price" class="text-center" style="margin-bottom: 10px;">
                                    <img :src="product.image" height="120">

                                </div>
                                <span></span>

                                <div v-if="product.sell_price" class="text-center">
                                    <button v-if="product.sell_price" type="button" class="btn btn-primary"
                                        data-toggle="modal" data-target="#myModal">Zoom Image</button>
                                </div>
                                    ...
                                    <div class="modal-dialog " style="max-width : 700px">
                                        <div class="modal-content">
                                            <div class="modal-body text-center">
                                                <img :src="product.image" width="640" class="img-responsive">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control text-center" v-model="qty" placeholder="Qty"
                                        min="1">
                                </div>
                                <div class="text-end">
        ...
        const searchProduct = () => {
            ...
            axios.post('/apps/transactions/searchProduct', {
                ...
                if (response.data.success) {
                    ...
                    product.value = {};
                    //set state "product" to empty array
                    products.value = [];
                }
            });
        }
                    ...
                    Swal.fire({
                        ...
                        .then(() => {
                            ...
                            setTimeout(() => {
                                ...
                                // location.reload();
                                //print
                                //window.open(`/apps/transactions/pdf?invoice=${response.data.data.invoice}`, '_blank');
                                //print

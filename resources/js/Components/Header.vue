<template>
  <header class="c-header c-header-light c-header-fixed c-header-with-subheader align-right">
...
<!-- 
    <button class="c-header-toggler c-class-toggler mfs-3 " type="button" data-target="#sidebar"
      data-class="c-sidebar-sm-show">
      <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
      </svg>
    </button> -->

    <ul class="c-header-nav ml-auto mr-md-4 d-lg-show">
